...
exports.notifyExpressJobsCF = exports.generateRecurringJobsCF = exports.createPaymentIntentCF = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const calc_1 = require("./calc");
const db = admin.firestore();
exports.createPaymentIntentCF = functions
    .region('europe-west1')
    ...
    try {
        const validation = (0, calc_1.validatePricingInputs)({
        ...
        const amounts = (0, calc_1.computeAmounts)({
        ...
        const paymentIntent = await stripe.paymentIntents.create({
            amount: Math.round(amounts.amountTotal * 100),
            currency: 'eur',
...
exports.generateRecurringJobsCF = functions
    .region('europe-west1')
    .https.onCall(async (data, context) => {
    var _a;
    if (!((_a = context.auth) === null || _a === void 0 ? void 0 : _a.uid)) {
...
exports.notifyExpressJobsCF = functions
    .region('europe-west1')
    ...
    try {
        ...
        for (const proDoc of prosQuery.docs) {
            ...
            const supportsServices = job.services.every((service) => { var _a; return (_a = pro.services) === null || _a === void 0 ? void 0 : _a.includes(service); });
            if (!supportsServices)
                continue;
